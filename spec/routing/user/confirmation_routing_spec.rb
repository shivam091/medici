...
RSpec.describe User::ConfirmationsController, type: :routing do
  ...
  it "GET /auth/verification/new should be routable" do
    expect(get("/auth/verification/new")).to be_routable
  end

  it "GET /auth/verification/new should route to user/confirmations#new" do
    expect(get("/auth/verification/new")).to route_to("user/confirmations#new")
  end

  it "GET new_user_confirmation_path should route to user/confirmations#new" do
    expect(get(new_user_confirmation_path)).to route_to("user/confirmations#new")
  end

  it "GET /auth/verification/new should route to user/confirmations#new" do
    expect(get("/auth/verification/new")).to route_to(controller: "user/confirmations", action: "new")
  end

  it "GET /auth/verification should be routable" do
    expect(get("/auth/verification")).to be_routable
  end

  it "GET /auth/verification should route to user/confirmations#show" do
    expect(get("/auth/verification")).to route_to("user/confirmations#show")
  end

  it "GET user_confirmation_path should route to user/confirmations#show" do
    expect(get(user_confirmation_path)).to route_to("user/confirmations#show")
  end

  it "GET /auth/verification should route to user/confirmations#show" do
    expect(get("/auth/verification")).to route_to(controller: "user/confirmations", action: "show")
  end

  it "POST /auth/verification should be routable" do
    expect(post("/auth/verification")).to be_routable
  end

  it "POST /auth/verification should route to user/confirmations#create" do
    expect(post("/auth/verification")).to route_to("user/confirmations#create")
  end

  it "POST user_confirmation_path should route to user/confirmations#create" do
    expect(post(user_confirmation_path)).to route_to("user/confirmations#create")
  end

  it "POST /auth/verification should route to user/confirmations#create" do
    expect(post("/auth/verification")).to route_to(controller: "user/confirmations", action: "create")
  end
end
