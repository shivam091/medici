  ...
  en: {
    purchase_orders: {
      ...
      purchase_order: {
        ...
        actions: "Actions",
        no_purchase_orders_to_display: "There are no purchase orders to display.",
        no_pending_purchase_orders_to_display: "There are no pending purchase orders to display.",
